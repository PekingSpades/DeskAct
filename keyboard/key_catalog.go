...
var keyNames = []string{
	...
	Backspace, Delete, Enter, Tab, Esc, Escape, Up, Down, Right, Left, Home, End,
	Pageup, Pagedown,
	F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, F13, F14, F15, F16, F17,
	F18, F19, F20, F21, F22, F23, F24,
	Cmd, Lcmd, Rcmd, Alt, Lalt, Ralt, Ctrl, Lctrl, Rctrl, Control, Shift, Lshift,
	Rshift, Capslock, Space, Print, Printscreen, Insert, Menu,
...
// KeyAliases returns a copy of the supported key aliases.
func KeyAliases() map[string]string {
	aliases := make(map[string]string, len(keyAliases))
